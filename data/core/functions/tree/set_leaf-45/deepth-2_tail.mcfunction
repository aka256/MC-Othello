#> core:tree/set_leaf-45/deepth-2_tail
...
execute if score $t17 Temp matches 0 run schedule function core:tree/set_leaf-45/deepth-2_head 1t
execute if score $t17 Temp matches 1 run function core:tree/set_leaf-45/deepth-1_tail