#> core:tree/set_leaf-23/deepth-2_skip
...
# candidateが生成されたかによる分岐
  ...
  execute unless data storage othello: candidate[0] run function core:tree/set_leaf-23/deepth-2_end
  ...
  execute if data storage othello: candidate[0] run function core:tree/set_leaf-23/deepth-3
  function core:control/change_player/main