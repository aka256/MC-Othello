#> core:tree/set_leaf-23/deepth-1_tail
...
# リストtreeの回転
  ...
  execute if score $t11 Temp matches 0 run function core:control/change_player/main
  execute if score $t11 Temp matches 0 run schedule function core:tree/set_leaf-23/deepth-1_head 1t
