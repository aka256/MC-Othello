...
execute store result storage othello:tree tree[0].player int 1 run scoreboard players get $waiting Settings

function core:control/change_player/main
function core:tree/initialize/2
function core:control/change_player/main
...
execute unless score $t9 Temp matches ..0 run function core:tree/initialize/1
...
#execute if score $t0 Temp matches 1.. run function core:tree/initialize/1