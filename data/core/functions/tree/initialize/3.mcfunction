...
scoreboard players remove $t11 Temp 1
execute unless score $t11 Temp matches ..0 run function core:tree/initialize/3
...
#execute if score $t0 Temp matches 1.. run function core:tree/initialize/3