...
execute if score $t0 Temp = $player Settings run scoreboard players operation $v0 Return += 0-0 EvalConst
execute if score $t0 Temp = $waiting Settings run scoreboard players operation $v0 Return -= 0-0 EvalConst
execute store result score $t0 Temp run data get storage othello: board[0][1]
execute if score $t0 Temp = $player Settings run scoreboard players operation $v0 Return += 0-1 EvalConst
execute if score $t0 Temp = $waiting Settings run scoreboard players operation $v0 Return -= 0-1 EvalConst
execute store result score $t0 Temp run data get storage othello: board[0][2]
execute if score $t0 Temp = $player Settings run scoreboard players operation $v0 Return += 0-2 EvalConst
execute if score $t0 Temp = $waiting Settings run scoreboard players operation $v0 Return -= 0-2 EvalConst
execute store result score $t0 Temp run data get storage othello: board[0][3]
execute if score $t0 Temp = $player Settings run scoreboard players operation $v0 Return += 0-3 EvalConst
execute if score $t0 Temp = $waiting Settings run scoreboard players operation $v0 Return -= 0-3 EvalConst
...
execute if score $t0 Temp = $player Settings run scoreboard players operation $v0 Return += 1-1 EvalConst
execute if score $t0 Temp = $waiting Settings run scoreboard players operation $v0 Return -= 1-1 EvalConst
execute store result score $t0 Temp run data get storage othello: board[1][2]
execute if score $t0 Temp = $player Settings run scoreboard players operation $v0 Return += 1-2 EvalConst
execute if score $t0 Temp = $waiting Settings run scoreboard players operation $v0 Return -= 1-2 EvalConst
...
execute if score $t0 Temp = $player Settings run scoreboard players operation $v0 Return += 2-2 EvalConst
execute if score $t0 Temp = $waiting Settings run scoreboard players operation $v0 Return -= 2-2 EvalConst
execute store result score $t0 Temp run data get storage othello: board[2][3]
execute if score $t0 Temp = $player Settings run scoreboard players operation $v0 Return += 2-3 EvalConst
execute if score $t0 Temp = $waiting Settings run scoreboard players operation $v0 Return -= 2-3 EvalConst
