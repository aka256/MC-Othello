#> core:evaluation/minmax/3
# @within core:evaluation/minmax/*

execute if data storage othello:tree tree[0].next[0].next[0].next[0] run function core:evaluation/minmax/3-0
execute unless data storage othello:tree tree[0].next[0].next[0].next[0] run function core:evaluation/minmax/3-1
...
execute if score $t14 Temp matches 0 run function core:evaluation/minmax/3