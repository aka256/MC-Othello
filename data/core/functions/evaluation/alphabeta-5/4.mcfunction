#> core:evaluation/alphabeta-5/4
# @within core:evaluation/alphabeta-5/*

execute if data storage othello:tree tree[0].next[0].next[0].next[0].next[0] run function core:evaluation/alphabeta-5/4-0
execute unless data storage othello:tree tree[0].next[0].next[0].next[0].next[0] run function core:evaluation/alphabeta-5/4-1
...
execute if score $t14 Temp matches 0 run function core:evaluation/alphabeta-5/4