...
execute if score $0 Const <= $a0 Argument if score $a0 Argument <= $7 Const if score $0 Const <= $a1 Argument if score $a1 Argument <= $7 Const run function core:set/candidate/3