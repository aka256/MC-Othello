#> core:set/candidate/board_legacy/1
#
# 8方向に対する探査を行うfunction
#
# @within core:set/candidate/board_legacy/main
...
function core:set/candidate/board_legacy/2
...
execute if score $t5 Temp matches 1 run function core:set/candidate/board_legacy/8