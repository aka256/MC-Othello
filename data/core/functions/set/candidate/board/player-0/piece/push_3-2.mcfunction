#> core:set/candidate/board/player-0/piece/push_3-2
# @within core:set/candidate/board/player-0/piece/3-2

# boardに値を代入
data modify storage othello: board[3][2].piece.player set value 0
...
# temp_boardへ候補を設定
data modify storage othello: temp_board[3][2].piece.player set value 2
