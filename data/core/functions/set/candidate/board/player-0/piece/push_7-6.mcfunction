#> core:set/candidate/board/player-0/piece/push_7-6
# @within core:set/candidate/board/player-0/piece/7-6

# boardに値を代入
data modify storage othello: board[7][6].piece.player set value 0
