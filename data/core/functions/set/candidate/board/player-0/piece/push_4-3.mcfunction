#> core:set/candidate/board/player-0/piece/push_4-3
# @within core:set/candidate/board/player-0/piece/4-3

# boardに値を代入
data modify storage othello: board[4][3].piece.player set value 0
