#> core:set/candidate/board/player-0/piece/push_2-5
# @within core:set/candidate/board/player-0/piece/2-5

# boardに値を代入
data modify storage othello: board[2][5].piece.player set value 0
