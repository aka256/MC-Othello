#> core:set/candidate/board/player-0/piece/push_4-7
# @within core:set/candidate/board/player-0/piece/4-7

# boardに値を代入
data modify storage othello: board[4][7].piece.player set value 0
