#> core:set/candidate/board/player-0/piece/push_5-6
# @within core:set/candidate/board/player-0/piece/5-6

# boardに値を代入
data modify storage othello: board[5][6].piece.player set value 0
