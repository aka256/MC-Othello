#> core:set/candidate/board/player-0/piece/push_7-3
# @within core:set/candidate/board/player-0/piece/7-3

# boardに値を代入
data modify storage othello: board[7][3].piece.player set value 0
