#> core:set/candidate/board/player-0/piece/7-6
...
execute if data storage othello: board[6][6].piece{player:1} run function core:set/candidate/board/player-0/search/x5d-y6n
execute if score $t1 Temp matches 1 run data modify storage othello: board[6][6].piece.player set value 0

scoreboard players set $t1 Temp 0
execute if data storage othello: board[6][5].piece{player:1} run function core:set/candidate/board/player-0/search/x5d-y4d
...
execute if score $t0 Temp matches 1 run function core:set/candidate/board/player-0/piece/push_7-6
