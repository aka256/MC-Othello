#> core:set/candidate/board/player-0/piece/push_0-5
# @within core:set/candidate/board/player-0/piece/0-5

# boardに値を代入
data modify storage othello: board[0][5].piece.player set value 0
