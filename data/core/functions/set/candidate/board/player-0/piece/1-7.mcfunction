#> core:set/candidate/board/player-0/piece/1-7
...
scoreboard players set $t1 Temp 0
execute if data storage othello: board[1][6].piece{player:1} run function core:set/candidate/board/player-0/search/x1n-y5d
execute if score $t1 Temp matches 1 run data modify storage othello: board[1][6].piece.player set value 0

scoreboard players set $t1 Temp 0
execute if data storage othello: board[2][6].piece{player:1} run function core:set/candidate/board/player-0/search/x3i-y5d
execute if score $t1 Temp matches 1 run data modify storage othello: board[2][6].piece.player set value 0

execute if score $t0 Temp matches 1 run function core:set/candidate/board/player-0/piece/push_1-7
