#> core:set/candidate/board/player-0/piece/push_0-4
# @within core:set/candidate/board/player-0/piece/0-4

# boardに値を代入
data modify storage othello: board[0][4].piece.player set value 0
...
# temp_boardへ候補を設定
data modify storage othello: temp_board[0][4].piece.player set value 2
