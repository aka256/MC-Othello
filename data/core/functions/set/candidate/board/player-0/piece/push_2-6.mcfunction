#> core:set/candidate/board/player-0/piece/push_2-6
# @within core:set/candidate/board/player-0/piece/2-6

# boardに値を代入
data modify storage othello: board[2][6].piece.player set value 0
