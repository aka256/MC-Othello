#> core:set/candidate/board/player-0/piece/push_3-0
# @within core:set/candidate/board/player-0/piece/3-0

# boardに値を代入
data modify storage othello: board[3][0].piece.player set value 0
