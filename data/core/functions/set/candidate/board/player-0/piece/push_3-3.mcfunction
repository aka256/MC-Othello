#> core:set/candidate/board/player-0/piece/push_3-3
# @within core:set/candidate/board/player-0/piece/3-3

# boardに値を代入
data modify storage othello: board[3][3].piece.player set value 0
