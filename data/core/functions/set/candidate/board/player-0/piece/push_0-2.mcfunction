#> core:set/candidate/board/player-0/piece/push_0-2
# @within core:set/candidate/board/player-0/piece/0-2

# boardに値を代入
data modify storage othello: board[0][2].piece.player set value 0
...
# temp_boardへ候補を設定
data modify storage othello: temp_board[0][2].piece.player set value 2
