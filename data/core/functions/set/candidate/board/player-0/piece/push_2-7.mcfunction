#> core:set/candidate/board/player-0/piece/push_2-7
# @within core:set/candidate/board/player-0/piece/2-7

# boardに値を代入
data modify storage othello: board[2][7].piece.player set value 0
...
# temp_boardへ候補を設定
data modify storage othello: temp_board[2][7].piece.player set value 2
