#> core:set/candidate/board/player-0/piece/push_5-7
# @within core:set/candidate/board/player-0/piece/5-7

# boardに値を代入
data modify storage othello: board[5][7].piece.player set value 0
