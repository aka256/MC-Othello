#> core:set/candidate/board/player-0/piece/push_5-1
# @within core:set/candidate/board/player-0/piece/5-1

# boardに値を代入
data modify storage othello: board[5][1].piece.player set value 0
...
# temp_boardへ候補を設定
data modify storage othello: temp_board[5][1].piece.player set value 2
