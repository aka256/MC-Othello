#> core:set/candidate/board/player-0/piece/push_0-3
# @within core:set/candidate/board/player-0/piece/0-3

# boardに値を代入
data modify storage othello: board[0][3].piece.player set value 0
