#> core:set/candidate/board/player-0/piece/push_1-3
# @within core:set/candidate/board/player-0/piece/1-3

# boardに値を代入
data modify storage othello: board[1][3].piece.player set value 0
