#> core:set/candidate/board/player-0/piece/push_6-4
# @within core:set/candidate/board/player-0/piece/6-4

# boardに値を代入
data modify storage othello: board[6][4].piece.player set value 0
