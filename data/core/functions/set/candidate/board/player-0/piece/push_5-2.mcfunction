#> core:set/candidate/board/player-0/piece/push_5-2
# @within core:set/candidate/board/player-0/piece/5-2

# boardに値を代入
data modify storage othello: board[5][2].piece.player set value 0
