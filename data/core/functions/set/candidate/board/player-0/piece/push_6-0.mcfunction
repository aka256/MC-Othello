#> core:set/candidate/board/player-0/piece/push_6-0
# @within core:set/candidate/board/player-0/piece/6-0

# boardに値を代入
data modify storage othello: board[6][0].piece.player set value 0
