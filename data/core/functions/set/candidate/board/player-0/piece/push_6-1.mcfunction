#> core:set/candidate/board/player-0/piece/push_6-1
# @within core:set/candidate/board/player-0/piece/6-1

# boardに値を代入
data modify storage othello: board[6][1].piece.player set value 0
