#> core:set/candidate/board/player-0/piece/push_4-4
# @within core:set/candidate/board/player-0/piece/4-4

# boardに値を代入
data modify storage othello: board[4][4].piece.player set value 0
