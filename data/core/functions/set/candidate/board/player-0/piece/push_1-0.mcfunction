#> core:set/candidate/board/player-0/piece/push_1-0
# @within core:set/candidate/board/player-0/piece/1-0

# boardに値を代入
data modify storage othello: board[1][0].piece.player set value 0
