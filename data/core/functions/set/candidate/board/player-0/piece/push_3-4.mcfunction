#> core:set/candidate/board/player-0/piece/push_3-4
# @within core:set/candidate/board/player-0/piece/3-4

# boardに値を代入
data modify storage othello: board[3][4].piece.player set value 0
