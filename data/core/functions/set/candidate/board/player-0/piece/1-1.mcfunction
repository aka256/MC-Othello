#> core:set/candidate/board/player-0/piece/1-1
...
scoreboard players set $t1 Temp 0
execute if data storage othello: board[2][2].piece{player:1} run function core:set/candidate/board/player-0/search/x3i-y3i
execute if score $t1 Temp matches 1 run data modify storage othello: board[2][2].piece.player set value 0

scoreboard players set $t1 Temp 0
execute if data storage othello: board[1][2].piece{player:1} run function core:set/candidate/board/player-0/search/x1n-y3i
execute if score $t1 Temp matches 1 run data modify storage othello: board[1][2].piece.player set value 0

execute if score $t0 Temp matches 1 run function core:set/candidate/board/player-0/piece/push_1-1
