#> core:set/candidate/board/player-0/piece/push_7-0
# @within core:set/candidate/board/player-0/piece/7-0

# boardに値を代入
data modify storage othello: board[7][0].piece.player set value 0
