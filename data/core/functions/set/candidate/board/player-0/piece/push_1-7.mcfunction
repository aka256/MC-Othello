#> core:set/candidate/board/player-0/piece/push_1-7
# @within core:set/candidate/board/player-0/piece/1-7

# boardに値を代入
data modify storage othello: board[1][7].piece.player set value 0
