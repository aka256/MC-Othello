#> core:set/candidate/board/player-0/piece/push_7-7
# @within core:set/candidate/board/player-0/piece/7-7

# boardに値を代入
data modify storage othello: board[7][7].piece.player set value 0
