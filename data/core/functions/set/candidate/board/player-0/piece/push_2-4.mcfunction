#> core:set/candidate/board/player-0/piece/push_2-4
# @within core:set/candidate/board/player-0/piece/2-4

# boardに値を代入
data modify storage othello: board[2][4].piece.player set value 0
