#> core:set/candidate/board/player-0/piece/push_5-0
# @within core:set/candidate/board/player-0/piece/5-0

# boardに値を代入
data modify storage othello: board[5][0].piece.player set value 0
