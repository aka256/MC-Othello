#> core:set/candidate/board/player-0/piece/push_2-3
# @within core:set/candidate/board/player-0/piece/2-3

# boardに値を代入
data modify storage othello: board[2][3].piece.player set value 0
