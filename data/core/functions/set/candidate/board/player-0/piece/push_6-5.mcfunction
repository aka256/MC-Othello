#> core:set/candidate/board/player-0/piece/push_6-5
# @within core:set/candidate/board/player-0/piece/6-5

# boardに値を代入
data modify storage othello: board[6][5].piece.player set value 0
...
# temp_boardへ候補を設定
data modify storage othello: temp_board[6][5].piece.player set value 2
