#> core:set/candidate/board/player-0/piece/push_2-2
# @within core:set/candidate/board/player-0/piece/2-2

# boardに値を代入
data modify storage othello: board[2][2].piece.player set value 0
...
# temp_boardへ候補を設定
data modify storage othello: temp_board[2][2].piece.player set value 2
