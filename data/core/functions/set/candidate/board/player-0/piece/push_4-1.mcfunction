#> core:set/candidate/board/player-0/piece/push_4-1
# @within core:set/candidate/board/player-0/piece/4-1

# boardに値を代入
data modify storage othello: board[4][1].piece.player set value 0
