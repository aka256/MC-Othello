#> core:set/candidate/board/player-0/piece/push_4-2
# @within core:set/candidate/board/player-0/piece/4-2

# boardに値を代入
data modify storage othello: board[4][2].piece.player set value 0

# candidateへpushするbaseの設定
  # cordinateを代入
  data modify storage othello: base.cordinate[0] set value 4
  data modify storage othello: base.cordinate[1] set value 2
  # boardを代入
...
# temp_boardへ候補を設定
data modify storage othello: temp_board[4][2].piece.player set value 2
