#> core:set/candidate/board/player-0/piece/3-1
...
execute if data storage othello: board[4][1].piece{player:1} run function core:set/candidate/board/player-0/search/x5i-y1n
execute if score $t1 Temp matches 1 run data modify storage othello: board[4][1].piece.player set value 0

scoreboard players set $t1 Temp 0
execute if data storage othello: board[4][2].piece{player:1} run function core:set/candidate/board/player-0/search/x5i-y3i
execute if score $t1 Temp matches 1 run data modify storage othello: board[4][2].piece.player set value 0

scoreboard players set $t1 Temp 0
execute if data storage othello: board[3][2].piece{player:1} run function core:set/candidate/board/player-0/search/x3n-y3i
...
scoreboard players set $t1 Temp 0
execute if data storage othello: board[2][1].piece{player:1} run function core:set/candidate/board/player-0/search/x1d-y1n
execute if score $t1 Temp matches 1 run data modify storage othello: board[2][1].piece.player set value 0

execute if score $t0 Temp matches 1 run function core:set/candidate/board/player-0/piece/push_3-1
