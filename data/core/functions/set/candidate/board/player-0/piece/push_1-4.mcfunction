#> core:set/candidate/board/player-0/piece/push_1-4
# @within core:set/candidate/board/player-0/piece/1-4

# boardに値を代入
data modify storage othello: board[1][4].piece.player set value 0
