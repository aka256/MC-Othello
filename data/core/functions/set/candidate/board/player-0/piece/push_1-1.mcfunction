#> core:set/candidate/board/player-0/piece/push_1-1
# @within core:set/candidate/board/player-0/piece/1-1

# boardに値を代入
data modify storage othello: board[1][1].piece.player set value 0
