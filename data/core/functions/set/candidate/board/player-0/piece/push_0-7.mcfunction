#> core:set/candidate/board/player-0/piece/push_0-7
# @within core:set/candidate/board/player-0/piece/0-7

# boardに値を代入
data modify storage othello: board[0][7].piece.player set value 0
