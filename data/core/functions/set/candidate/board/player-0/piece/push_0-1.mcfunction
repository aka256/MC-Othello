#> core:set/candidate/board/player-0/piece/push_0-1
# @within core:set/candidate/board/player-0/piece/0-1

# boardに値を代入
data modify storage othello: board[0][1].piece.player set value 0

# candidateへpushするbaseの設定
  # cordinateを代入
  data modify storage othello: base.cordinate[0] set value 0
  data modify storage othello: base.cordinate[1] set value 1
  # boardを代入
...
# temp_boardへ候補を設定
data modify storage othello: temp_board[0][1].piece.player set value 2
