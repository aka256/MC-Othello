#> core:set/candidate/board/player-0/piece/push_3-1
# @within core:set/candidate/board/player-0/piece/3-1

# boardに値を代入
data modify storage othello: board[3][1].piece.player set value 0
...
# temp_boardへ候補を設定
data modify storage othello: temp_board[3][1].piece.player set value 2
