#> core:set/candidate/board/player-0/search/x6i-y7n
# @within core:set/candidate/board/player-0/**

execute if data storage othello: board[6][7].piece{player:0} run scoreboard players set $t1 Temp 1
execute if data storage othello: board[6][7].piece{player:1} if data storage othello: board[7][7].piece{player:0} run scoreboard players set $t1 Temp 1
