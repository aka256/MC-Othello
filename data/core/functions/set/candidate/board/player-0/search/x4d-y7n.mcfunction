#> core:set/candidate/board/player-0/search/x4d-y7n
...
execute if data storage othello: board[4][7].piece{player:0} run scoreboard players set $t0 Temp 1
execute if data storage othello: board[4][7].piece{player:0} run scoreboard players set $t1 Temp 1
