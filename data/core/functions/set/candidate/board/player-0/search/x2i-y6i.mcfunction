#> core:set/candidate/board/player-0/search/x2i-y6i
...
execute if data storage othello: board[2][6].piece{player:1} if data storage othello: board[3][7].piece{player:0} run scoreboard players set $t1 Temp 1
