#> core:set/candidate/board/player-0/search/x1d-y3n
...
execute if data storage othello: board[1][3].piece{player:1} if data storage othello: board[0][3].piece{player:0} run scoreboard players set $t1 Temp 1
