#> core:set/candidate/board/player-0/search/x4d-y1d
...
execute if data storage othello: board[4][1].piece{player:1} if data storage othello: board[3][0].piece{player:0} run scoreboard players set $t1 Temp 1
