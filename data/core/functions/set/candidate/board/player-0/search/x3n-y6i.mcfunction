#> core:set/candidate/board/player-0/search/x3n-y6i
# @within core:set/candidate/board/player-0/**

execute if data storage othello: board[3][6].piece{player:1} run function core:set/candidate/board/player-0/search/x3n-y7i
