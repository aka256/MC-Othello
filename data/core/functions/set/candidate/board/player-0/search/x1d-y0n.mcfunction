#> core:set/candidate/board/player-0/search/x1d-y0n
# @within core:set/candidate/board/player-0/**

execute if data storage othello: board[1][0].piece{player:0} run scoreboard players set $t1 Temp 1
execute if data storage othello: board[1][0].piece{player:1} if data storage othello: board[0][0].piece{player:0} run scoreboard players set $t1 Temp 1
