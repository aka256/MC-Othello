#> core:set/candidate/board/player-0/search/x2n-y6i
# @within core:set/candidate/board/player-0/**

execute if data storage othello: board[2][6].piece{player:1} run function core:set/candidate/board/player-0/search/x2n-y7i
