#> core:set/candidate/board/player-0/search/x5i-y6i
...
execute if data storage othello: board[5][6].piece{player:1} if data storage othello: board[6][7].piece{player:0} run scoreboard players set $t1 Temp 1
