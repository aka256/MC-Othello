#> core:set/candidate/board/player-0/search/x6i-y2d
...
execute if data storage othello: board[6][2].piece{player:1} if data storage othello: board[7][1].piece{player:0} run scoreboard players set $t1 Temp 1
