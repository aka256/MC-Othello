#> core:set/candidate/board/player-1/search/x5i-y1d
# @within core:set/candidate/board/player-1/**

execute if data storage othello: board[5][1].piece{player:1} run scoreboard players set $t1 Temp 1
execute if data storage othello: board[5][1].piece{player:0} if data storage othello: board[6][0].piece{player:1} run scoreboard players set $t1 Temp 1
