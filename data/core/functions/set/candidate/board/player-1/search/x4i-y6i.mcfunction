#> core:set/candidate/board/player-1/search/x4i-y6i
# @within core:set/candidate/board/player-1/**

execute if data storage othello: board[4][6].piece{player:1} run scoreboard players set $t1 Temp 1
execute if data storage othello: board[4][6].piece{player:0} if data storage othello: board[5][7].piece{player:1} run scoreboard players set $t1 Temp 1
