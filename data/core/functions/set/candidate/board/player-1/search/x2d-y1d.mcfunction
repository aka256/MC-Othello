#> core:set/candidate/board/player-1/search/x2d-y1d
# @within core:set/candidate/board/player-1/**

execute if data storage othello: board[2][1].piece{player:1} run scoreboard players set $t1 Temp 1
execute if data storage othello: board[2][1].piece{player:0} if data storage othello: board[1][0].piece{player:1} run scoreboard players set $t1 Temp 1
