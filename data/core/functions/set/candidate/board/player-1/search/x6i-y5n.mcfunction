#> core:set/candidate/board/player-1/search/x6i-y5n
# @within core:set/candidate/board/player-1/**

execute if data storage othello: board[6][5].piece{player:1} run scoreboard players set $t1 Temp 1
execute if data storage othello: board[6][5].piece{player:0} if data storage othello: board[7][5].piece{player:1} run scoreboard players set $t1 Temp 1
