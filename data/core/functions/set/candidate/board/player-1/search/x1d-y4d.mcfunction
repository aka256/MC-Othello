#> core:set/candidate/board/player-1/search/x1d-y4d
# @within core:set/candidate/board/player-1/**

execute if data storage othello: board[1][4].piece{player:1} run scoreboard players set $t1 Temp 1
execute if data storage othello: board[1][4].piece{player:0} if data storage othello: board[0][3].piece{player:1} run scoreboard players set $t1 Temp 1
