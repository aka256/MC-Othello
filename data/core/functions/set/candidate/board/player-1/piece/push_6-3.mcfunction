#> core:set/candidate/board/player-1/piece/push_6-3
# @within core:set/candidate/board/player-1/piece/6-3

# boardに値を代入
data modify storage othello: board[6][3].piece.player set value 1
