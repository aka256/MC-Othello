#> core:set/candidate/board/player-1/piece/push_6-2
# @within core:set/candidate/board/player-1/piece/6-2

# boardに値を代入
data modify storage othello: board[6][2].piece.player set value 1
