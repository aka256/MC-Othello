#> core:set/candidate/board/player-1/piece/push_4-2
# @within core:set/candidate/board/player-1/piece/4-2

# boardに値を代入
data modify storage othello: board[4][2].piece.player set value 1
