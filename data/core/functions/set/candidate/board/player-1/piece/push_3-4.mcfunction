#> core:set/candidate/board/player-1/piece/push_3-4
# @within core:set/candidate/board/player-1/piece/3-4

# boardに値を代入
data modify storage othello: board[3][4].piece.player set value 1
...
# temp_boardへ候補を設定
data modify storage othello: temp_board[3][4].piece.player set value 2
