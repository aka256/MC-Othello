#> core:set/candidate/board/player-1/piece/push_0-2
# @within core:set/candidate/board/player-1/piece/0-2

# boardに値を代入
data modify storage othello: board[0][2].piece.player set value 1
