#> core:set/candidate/board/player-1/piece/push_5-4
# @within core:set/candidate/board/player-1/piece/5-4

# boardに値を代入
data modify storage othello: board[5][4].piece.player set value 1
