#> core:set/candidate/board/player-1/piece/push_7-4
# @within core:set/candidate/board/player-1/piece/7-4

# boardに値を代入
data modify storage othello: board[7][4].piece.player set value 1
