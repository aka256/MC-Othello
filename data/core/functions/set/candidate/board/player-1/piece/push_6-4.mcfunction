#> core:set/candidate/board/player-1/piece/push_6-4
# @within core:set/candidate/board/player-1/piece/6-4

# boardに値を代入
data modify storage othello: board[6][4].piece.player set value 1
...
# temp_boardへ候補を設定
data modify storage othello: temp_board[6][4].piece.player set value 2
