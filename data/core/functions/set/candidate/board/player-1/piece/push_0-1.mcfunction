#> core:set/candidate/board/player-1/piece/push_0-1
# @within core:set/candidate/board/player-1/piece/0-1

# boardに値を代入
data modify storage othello: board[0][1].piece.player set value 1
