#> core:set/candidate/board/player-1/piece/push_0-0
# @within core:set/candidate/board/player-1/piece/0-0

# boardに値を代入
data modify storage othello: board[0][0].piece.player set value 1
