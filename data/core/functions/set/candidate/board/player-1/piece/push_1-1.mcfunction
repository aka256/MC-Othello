#> core:set/candidate/board/player-1/piece/push_1-1
# @within core:set/candidate/board/player-1/piece/1-1

# boardに値を代入
data modify storage othello: board[1][1].piece.player set value 1
...
# temp_boardへ候補を設定
data modify storage othello: temp_board[1][1].piece.player set value 2
