#> core:set/candidate/board/player-1/piece/push_3-5
# @within core:set/candidate/board/player-1/piece/3-5

# boardに値を代入
data modify storage othello: board[3][5].piece.player set value 1
