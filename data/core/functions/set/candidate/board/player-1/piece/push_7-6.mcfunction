#> core:set/candidate/board/player-1/piece/push_7-6
# @within core:set/candidate/board/player-1/piece/7-6

# boardに値を代入
data modify storage othello: board[7][6].piece.player set value 1
...
# temp_boardへ候補を設定
data modify storage othello: temp_board[7][6].piece.player set value 2
