#> core:set/candidate/board/player-1/piece/push_0-6
# @within core:set/candidate/board/player-1/piece/0-6

# boardに値を代入
data modify storage othello: board[0][6].piece.player set value 1
