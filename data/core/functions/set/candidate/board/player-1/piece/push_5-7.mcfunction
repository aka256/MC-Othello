#> core:set/candidate/board/player-1/piece/push_5-7
# @within core:set/candidate/board/player-1/piece/5-7

# boardに値を代入
data modify storage othello: board[5][7].piece.player set value 1
...
# temp_boardへ候補を設定
data modify storage othello: temp_board[5][7].piece.player set value 2
