#> core:set/candidate/board/player-1/piece/push_7-7
# @within core:set/candidate/board/player-1/piece/7-7

# boardに値を代入
data modify storage othello: board[7][7].piece.player set value 1
...
# temp_boardへ候補を設定
data modify storage othello: temp_board[7][7].piece.player set value 2
