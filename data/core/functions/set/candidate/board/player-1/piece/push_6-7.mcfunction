#> core:set/candidate/board/player-1/piece/push_6-7
# @within core:set/candidate/board/player-1/piece/6-7

# boardに値を代入
data modify storage othello: board[6][7].piece.player set value 1
