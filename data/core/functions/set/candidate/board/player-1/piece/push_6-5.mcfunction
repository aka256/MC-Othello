#> core:set/candidate/board/player-1/piece/push_6-5
# @within core:set/candidate/board/player-1/piece/6-5

# boardに値を代入
data modify storage othello: board[6][5].piece.player set value 1
