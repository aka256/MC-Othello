#> core:set/candidate/board/player-1/piece/push_2-4
# @within core:set/candidate/board/player-1/piece/2-4

# boardに値を代入
data modify storage othello: board[2][4].piece.player set value 1
...
# temp_boardへ候補を設定
data modify storage othello: temp_board[2][4].piece.player set value 2
