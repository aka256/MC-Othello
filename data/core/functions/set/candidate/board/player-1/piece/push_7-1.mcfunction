#> core:set/candidate/board/player-1/piece/push_7-1
# @within core:set/candidate/board/player-1/piece/7-1

# boardに値を代入
data modify storage othello: board[7][1].piece.player set value 1
