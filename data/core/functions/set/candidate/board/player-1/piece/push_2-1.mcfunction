#> core:set/candidate/board/player-1/piece/push_2-1
# @within core:set/candidate/board/player-1/piece/2-1

# boardに値を代入
data modify storage othello: board[2][1].piece.player set value 1
