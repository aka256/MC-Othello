#> core:set/candidate/board/player-1/piece/push_5-5
# @within core:set/candidate/board/player-1/piece/5-5

# boardに値を代入
data modify storage othello: board[5][5].piece.player set value 1
