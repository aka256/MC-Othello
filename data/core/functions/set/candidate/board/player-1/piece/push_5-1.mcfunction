#> core:set/candidate/board/player-1/piece/push_5-1
# @within core:set/candidate/board/player-1/piece/5-1

# boardに値を代入
data modify storage othello: board[5][1].piece.player set value 1
