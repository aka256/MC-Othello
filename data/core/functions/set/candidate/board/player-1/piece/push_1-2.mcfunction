#> core:set/candidate/board/player-1/piece/push_1-2
# @within core:set/candidate/board/player-1/piece/1-2

# boardに値を代入
data modify storage othello: board[1][2].piece.player set value 1
