#> core:set/candidate/board/player-1/piece/push_4-0
# @within core:set/candidate/board/player-1/piece/4-0

# boardに値を代入
data modify storage othello: board[4][0].piece.player set value 1
