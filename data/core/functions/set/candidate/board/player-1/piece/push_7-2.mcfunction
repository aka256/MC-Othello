#> core:set/candidate/board/player-1/piece/push_7-2
# @within core:set/candidate/board/player-1/piece/7-2

# boardに値を代入
data modify storage othello: board[7][2].piece.player set value 1
