#> core:set/candidate/board/player-1/piece/push_7-5
# @within core:set/candidate/board/player-1/piece/7-5

# boardに値を代入
data modify storage othello: board[7][5].piece.player set value 1
