#> core:set/candidate/board/player-1/piece/push_5-2
# @within core:set/candidate/board/player-1/piece/5-2

# boardに値を代入
data modify storage othello: board[5][2].piece.player set value 1
...
# temp_boardへ候補を設定
data modify storage othello: temp_board[5][2].piece.player set value 2
