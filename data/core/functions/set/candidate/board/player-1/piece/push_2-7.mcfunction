#> core:set/candidate/board/player-1/piece/push_2-7
# @within core:set/candidate/board/player-1/piece/2-7

# boardに値を代入
data modify storage othello: board[2][7].piece.player set value 1
