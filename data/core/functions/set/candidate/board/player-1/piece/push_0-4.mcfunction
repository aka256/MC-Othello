#> core:set/candidate/board/player-1/piece/push_0-4
# @within core:set/candidate/board/player-1/piece/0-4

# boardに値を代入
data modify storage othello: board[0][4].piece.player set value 1
