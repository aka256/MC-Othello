#> core:set/candidate/board/player-1/piece/push_4-3
# @within core:set/candidate/board/player-1/piece/4-3

# boardに値を代入
data modify storage othello: board[4][3].piece.player set value 1
...
# temp_boardへ候補を設定
data modify storage othello: temp_board[4][3].piece.player set value 2
