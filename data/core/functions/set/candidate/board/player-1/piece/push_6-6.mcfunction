#> core:set/candidate/board/player-1/piece/push_6-6
# @within core:set/candidate/board/player-1/piece/6-6

# boardに値を代入
data modify storage othello: board[6][6].piece.player set value 1
