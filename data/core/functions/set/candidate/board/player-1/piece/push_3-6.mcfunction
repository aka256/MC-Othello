#> core:set/candidate/board/player-1/piece/push_3-6
# @within core:set/candidate/board/player-1/piece/3-6

# boardに値を代入
data modify storage othello: board[3][6].piece.player set value 1
