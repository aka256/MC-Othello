#> core:set/candidate/board/player-1/piece/push_3-2
# @within core:set/candidate/board/player-1/piece/3-2

# boardに値を代入
data modify storage othello: board[3][2].piece.player set value 1
