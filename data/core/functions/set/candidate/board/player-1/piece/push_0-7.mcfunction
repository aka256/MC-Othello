#> core:set/candidate/board/player-1/piece/push_0-7
# @within core:set/candidate/board/player-1/piece/0-7

# boardに値を代入
data modify storage othello: board[0][7].piece.player set value 1
...
# temp_boardへ候補を設定
data modify storage othello: temp_board[0][7].piece.player set value 2
