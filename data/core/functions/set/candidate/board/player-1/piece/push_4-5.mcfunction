#> core:set/candidate/board/player-1/piece/push_4-5
# @within core:set/candidate/board/player-1/piece/4-5

# boardに値を代入
data modify storage othello: board[4][5].piece.player set value 1
