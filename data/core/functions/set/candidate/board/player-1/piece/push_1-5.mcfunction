#> core:set/candidate/board/player-1/piece/push_1-5
# @within core:set/candidate/board/player-1/piece/1-5

# boardに値を代入
data modify storage othello: board[1][5].piece.player set value 1
