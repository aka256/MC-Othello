#> core:set/candidate/board/player-1/piece/push_4-6
# @within core:set/candidate/board/player-1/piece/4-6

# boardに値を代入
data modify storage othello: board[4][6].piece.player set value 1
