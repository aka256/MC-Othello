#> core:set/candidate/board/player-1/piece/push_1-6
# @within core:set/candidate/board/player-1/piece/1-6

# boardに値を代入
data modify storage othello: board[1][6].piece.player set value 1
