#> core:set/candidate/board/player-1/piece/push_3-7
# @within core:set/candidate/board/player-1/piece/3-7

# boardに値を代入
data modify storage othello: board[3][7].piece.player set value 1
