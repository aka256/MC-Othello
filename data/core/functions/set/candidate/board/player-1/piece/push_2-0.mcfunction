#> core:set/candidate/board/player-1/piece/push_2-0
# @within core:set/candidate/board/player-1/piece/2-0

# boardに値を代入
data modify storage othello: board[2][0].piece.player set value 1
