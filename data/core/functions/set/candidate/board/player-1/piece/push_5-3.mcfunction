#> core:set/candidate/board/player-1/piece/push_5-3
# @within core:set/candidate/board/player-1/piece/5-3

# boardに値を代入
data modify storage othello: board[5][3].piece.player set value 1
