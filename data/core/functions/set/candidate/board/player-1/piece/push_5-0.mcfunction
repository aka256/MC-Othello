#> core:set/candidate/board/player-1/piece/push_5-0
# @within core:set/candidate/board/player-1/piece/5-0

# boardに値を代入
data modify storage othello: board[5][0].piece.player set value 1
...
# temp_boardへ候補を設定
data modify storage othello: temp_board[5][0].piece.player set value 2
