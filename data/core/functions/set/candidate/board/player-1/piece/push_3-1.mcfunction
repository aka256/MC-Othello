#> core:set/candidate/board/player-1/piece/push_3-1
# @within core:set/candidate/board/player-1/piece/3-1

# boardに値を代入
data modify storage othello: board[3][1].piece.player set value 1
