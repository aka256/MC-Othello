#> core:set/candidate/board/player-1/piece/push_2-2
# @within core:set/candidate/board/player-1/piece/2-2

# boardに値を代入
data modify storage othello: board[2][2].piece.player set value 1
