#> core:set/piece/candidate/1
# @within
#   core:set/piece/candidate/main
#   core:set/piece/candidate/2
...
execute if score $t2 Temp matches 0 if score $t3 Temp matches 1 run function core:set/piece/candidate/2