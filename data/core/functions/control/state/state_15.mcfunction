#> core:control/state/state_15
# state = 15の時に呼び出されるfunction
# @internal
...
execute unless score $v0 Return = $aiPiece Global unless score $v0 Return matches 2 run schedule function core:tree/set_leaf/main 1t
execute unless score $v0 Return = $aiPiece Global unless score $v0 Return matches 2 run scoreboard players set $state Global 16
