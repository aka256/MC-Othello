...
execute if score $t25 Temp matches 1 run function ai:tree/set_leaf-45/deepth-4
execute if score $t25 Temp matches 0 run function ai:tree/set_leaf-45/deepth-3_skip
...
execute if score $t17 Temp matches 0 run schedule function ai:tree/set_leaf-45/deepth-3 1t
execute if score $t17 Temp matches 1 run function ai:tree/set_leaf-45/deepth-2_tail
