...
execute if data storage othello: candidate[0] run function ai:tree/set_leaf-45/deepth-5
execute unless data storage othello: candidate[0] run function ai:tree/set_leaf-45/deepth-4_skip
...
execute if score $t13 Temp matches 1.. run function ai:tree/set_leaf-45/deepth-4