#> ai:tree/set_leaf-45/deepth-2_head
...
# tree[0].next[0].next[0]が空でない場合、ai:tree/set_leaf-45/4を実行
...
execute if data storage othello:tree tree[0].next[0].next[0] run function ai:tree/set_leaf-45/deepth-3
