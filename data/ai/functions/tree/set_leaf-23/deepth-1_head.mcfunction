#> ai:tree/set_leaf-23/deepth-1_head
...
# candidateが生成されたかによる分岐
  ...
  execute if score $t6 Temp matches 1 run function ai:tree/set_leaf-23/deepth-2
  # candidateが生成されなかったとき、deepth-1_skipを実行
  execute if score $t6 Temp matches 0 run function ai:tree/set_leaf-23/deepth-1_skip
